...
- Both workflows (`artifacts/api-server: API Server`, `artifacts/takipci-paneli: web`) are running. Login verified working via `/api/auth/login`: `admin` / `admin123`.
